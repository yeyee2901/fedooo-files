...
if math.random(1, 2) == 1 then
	vim.g["startify_custom_header"] = vim.fn["startify#pad"](split(system("figlet -w 60 " .. word_choice), "\n"))
else
	vim.g["startify_custom_header"] = vim.fn["startify#pad"](split(system(what_does_the_cow_say), "\n"))
end
